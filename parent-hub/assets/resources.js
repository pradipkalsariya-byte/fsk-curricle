/* FSK Curricle — resource registry.
 *
...
window.FSK_RESOURCES = {
  ...
  // domain aliases (fsk.in, fsksurat.in, ...) — so parent fsk.in logins can
  ...
  "nucleus": {
    ...
    type: "url",
    url: "https://fskparents.nucleusedu.in/login"
  },
  ...
  "asc-timetable": {
    title: "ASC Timetable",
    type: "url",
    url: "https://fsk.edupage.org/timetable/"
  },
 ...
 *   FSKResources.url("uniform-policy")    → view link (opens Drive viewer)
 *   FSKResources.embed("uniform-policy")  → embeddable preview URL (iframes)
 *   FSKResources.title("uniform-policy")  → display title
 *
...
(function () {
  ...
  window.FSKResources = { url: url, embed: embed, title: title, wire: wire };
})();
